...
import { ValidationError, NotFoundError } from '../core/exception.js';
import { EntityType } from '../core/enum.js';
import { allowedEntities } from '../middleware/authMiddleware.js';
import { registerAdminSchema, deleteEntitySchema, StandardResponse } from '../schemas/adminSchema.js';
import { recipeInputSchema, recipeUpdateSchema } from '../schemas/recipes.js';
import { updateEntitySchema, getEntitySchema } from '../schemas/adminSchema.js';
import { cuisineModel } from '../models/cuisines.js';
...
router.post('/register', async (req, res, next) => {
  ...
  const resp = await authService.registerEntity(value)
